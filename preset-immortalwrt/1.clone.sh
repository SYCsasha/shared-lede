...
git clone --single-branch -b openwrt-23.05 https://github.com/immortalwrt/immortalwrt.git $CODE_DIR
mv ./$CODE_DIR/* ./
...
git clone --depth 1 https://github.com/kiddin9/openwrt-packages/tree/master/luci-app-ssr-plus.git
